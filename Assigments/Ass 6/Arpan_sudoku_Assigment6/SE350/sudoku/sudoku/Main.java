...
public class Main {
    ...
    public static void main (String[] args) {
        ...
        //timedSolveFromFile(4, "samples/sudoku_4x4.txt");
        System.out.println("Testing sudoku_easy.txt ");
        timedSolveFromFile(3, "samples/sudoku_easy.txt");
        System.out.println("Testing sudoku_easy2.txt ");
        timedSolveFromFile(3, "samples/sudoku_easy2.txt");
        System.out.println("Testing sudoku_evil.txt ");
        ...
        System.out.println("Testing sudoku_hard2.txt ");
        timedSolveFromFile(3, "samples/sudoku_hard.txt");
