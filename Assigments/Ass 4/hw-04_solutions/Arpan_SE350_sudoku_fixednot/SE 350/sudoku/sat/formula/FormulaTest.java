...
public class FormulaTest {    
    ...
    public void testOr() {
    	...
    	Clause clause5 = make(e);
    	Clause clause6 = make(f);
    	...
    	Formula form3 = new Formula(clause6);
    	form3 = form3.addClause(clause5);
//    	form3 = form3.addClause(make());
    	
    	//System.out.println(form.or(form2).or(form3));
    	
    	
       	form = new Formula(clause2);
    	form = form.addClause(clause1);
    	
    	form2 = new Formula(clause4);
    	form2 = form2.addClause(clause3);
    	form3 = form.or(form2);
